...
<body>
                            ...
                            <div class="cart__content">
                                ...
                                <div class="cart__title">
                                    <div class="row">
                                        ...
                                        <div class=" col-4  text-right text-muted  d-flex" style="justify-content: flex-end;">
    ...
    <script>
        $(document).ready(() => {
            ...
            function view_data() {
                $.ajax({
                    url: "http://localhost:3000/pages/Cart/handleCartData.php",
                    dataType: 'json',
                    method: "post",
                    cache: true,
            ...
            function view_cart() {
                $.post('http://localhost:3000/pages/Cart/listCart.php?pageIndex=' + pageIndexCart +
                    '&cartCount=' +
                    cartCount,
                    function(data) {
            ...
            $(document).on("click", '.page-link.cart', function() {
                ...
                $.ajax({
                    url: 'http://localhost:3000/pages/Cart/listCart.php?pageIndex=' +
            ...
            $(document).on("click", '.cart__delete-btn', function() {
                ...
                $.ajax({
                    url: "http://localhost:3000/pages/Cart/handleDeleteCart.php",
                    data: {
            ...
            $(document).on("click", '.plus-quantity-btn', function() {
                ...
                $.ajax({
                    url: "http://localhost:3000/pages/Cart/handlePlusQuantity.php",
                    data: {
                        id_sanpham: idProduct,
                    },
                    dataType: 'json',
            ...
            $(document).on("click", '.minus-quantity-btn', function() {
                ...
                console.log(idProduct)
                $.ajax({
                    url: "http://localhost:3000/pages/Cart/handleMinusQuantity.php",
                    data: {
                        id_sanpham: idProduct,
                    },
                    dataType: 'json',
            ...
            $(document).on("click", '.delete-all-cart-btn', function() {
                $.ajax({
                    url: "http://localhost:3000/pages/Cart/handleDeleteAllCart.php",
                    dataType: 'json',
                    method: "post",
                    cache: true,
                    success: function(data) {
