    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <?php
                ...
                ?>
            <li class="page-item">
                <a class="page-link main-order first-page-shopPage" value="<?php echo $first_page ?>"><i
            ...
            <?php
                ...
                ?>
            <li class="page-item">
                <a class="page-link main-order prev-page-shopPage" value="<?php echo $current_page - 1 ?>"><i
            ...
            <li class="page-item <?php echo ($current_page == $num) ? 'active' : '' ?>"><a class="page-link main-order"
            ...
            <?php
                ...
                ?>
            <li class=" page-item">
                <a class="page-link main-order next-page-shopPage" value="<?php echo $current_page + 1 ?>"><i
            ...
            <?php
                ...
                ?>
            <li class="page-item">
                <a class="page-link main-order last-page-shopPage" value="<?php echo $end_page ?>"><i
