...
if ($_POST['name'] == 1) {
    $sql = "SELECT * FROM tbl_sanpham, tbl_danhmuc  WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc  ORDER BY tbl_sanpham.tensanpham ASC";
...
?>
    ...
    ?>
        <h1 class="empty-row">Chưa có danh mục trạng thái kích hoạt</h1>
    <?php
    }
    ?>
    <?php
} else if ($_POST['name'] == 0) {
    $sql = "SELECT * FROM tbl_sanpham, tbl_danhmuc  WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc   ORDER BY tbl_sanpham.tensanpham DESC";
    $query = mysqli_query($mysqli, $sql);;
    if (mysqli_num_rows($query) > 0) {
        while ($row = mysqli_fetch_array($query)) {
    ?>
    ...
    ?>
        <h1 class="empty-row">Chưa có danh mục trạng thái ẩn</h1>
    <?php
    }
    ?>
<?php
