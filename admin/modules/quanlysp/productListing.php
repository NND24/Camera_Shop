        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-list">
                <li class="sidebar-list-item">
                    <a class="list-gallery">Quản lý danh mục
                        sản
                        phẩm</a>
                </li>
                <li class="sidebar-list-item ">
            ...
            <div class="app-content">
                ...
                <div class="products-area-wrapper tableView">
                    ...
                    <div class="products-row">
                        ...
                        <div class="product-cell col-2 sales"><?php echo date('d/m/Y H:i', $row['created_time']) ?>
                        </div>
                        <div class="product-cell col-2 stock"><?php echo date('d/m/Y H:i', $row['created_time']) ?>
                        </div>
                        ...
                        <div class="product-cell col btn">
                            <a title="Xóa"
                                href="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>"><i
                                    class="fa-solid fa-trash"></i></a>
                        </div>
                        <div class="product-cell col btn">
                            <!-- <a href="?action=quanlysanpham&query=sua&idsanpham=<?php echo $row['id_sanpham'] ?>">Sửa</a> -->
                            <a title="Sửa" class="edit-product-btn" data-id="<?php echo $row['id_sanpham'] ?>"><i
