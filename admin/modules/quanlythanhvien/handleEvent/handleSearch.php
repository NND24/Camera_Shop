...
if (isset($_POST['searchInput'])) {
    ...
    $sql = "SELECT * FROM tbl_admin WHERE username LIKE '%{$input}%' LIMIT " . $item_per_page . " OFFSET " . $offset . "";
    ...
    $totalRecords = mysqli_query($mysqli, "SELECT * FROM tbl_admin WHERE username LIKE '%{$input}%'");
        ...
        <div class="pagination__wrapper ">
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link searchCate first-page-shopPage" value="<?php echo $first_page ?>"><i class="fa-solid fa-angles-left"></i></a>
                        </li>
                    <?php
                    }
                    if ($current_page > 1) {
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link searchCate prev-page-shopPage" value="<?php echo $current_page - 1 ?>"><i class="fa-solid fa-angle-left"></i></a>
                        </li>
                    <?php } ?>
                    ...
                    <?php for ($num = 1; $num <= $totalPages; $num++) { ?>
                        <?php if ($num != $current_page) { ?>
                            <?php if ($num > $current_page - 3 && $num < $current_page + 3) { ?>
                                <li class="page-item <?php echo ($current_page == $num) ? 'active' : '' ?>"><a class="page-link searchCate" value="<?php echo $num ?>"><?php echo $num ?></a></li>
                            <?php } ?>
                        <?php } else { ?>
                            <li class="page-item <?php echo ($current_page == $num) ? 'active' : '' ?>"><a class="page-link searchCate" value="<?php echo $num ?>"><?php echo $num ?></a></li>
                        <?php } ?>
                    ...
                    ?>
                        <li class=" page-item">
                            <a class="page-link searchCate next-page-shopPage" value="<?php echo $current_page + 1 ?>"><i class="fa-solid fa-angle-right"></i></a>
                        </li>
                    <?php
                    }
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link searchCate last-page-shopPage" value="<?php echo $end_page ?>"><i class="fa-solid fa-angles-right"></i></a>
                        </li>
                    <?php
                    }
                    ?>
