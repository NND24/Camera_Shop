    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <?php
                ...
                ?>
            <li class="page-item">
                <a class="page-link mainMember first-page-shopPage" value="<?php echo $first_page ?>"><i
            ...
            <?php
                ...
                ?>
            <li class="page-item">
                <a class="page-link mainMember prev-page-shopPage" value="<?php echo $current_page - 1 ?>"><i
            ...
            <li class="page-item <?php echo ($current_page == $num) ? 'active' : '' ?>"><a class="page-link mainMember"
            ...
            <?php
                ...
                ?>
            <li class=" page-item">
                <a class="page-link mainMember next-page-shopPage" value="<?php echo $current_page + 1 ?>"><i
            ...
            <?php
                ...
                ?>
            <li class="page-item">
                <a class="page-link mainMember last-page-shopPage" value="<?php echo $end_page ?>"><i
