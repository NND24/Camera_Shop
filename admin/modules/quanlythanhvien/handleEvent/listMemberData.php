...
$sql_lietke_member = "SELECT * FROM tbl_admin ORDER BY id_admin ASC LIMIT " . $item_per_page . " OFFSET " . $offset . "";
$query_lietke_member = mysqli_query($mysqli, $sql_lietke_member);

$totalRecords = mysqli_query($mysqli, "SELECT * FROM tbl_admin");
...
?>
        <div class="products-row">
            ...
            <div class="product-cell col stock"><?php echo date('d/m/Y H:i', $row['last_updated']) ?>
            </div>
    ...
    <div class="pagination__wrapper ">
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                ?>
                    <li class="page-item">
                        <a class="page-link mainMember first-page-shopPage" value="<?php echo $first_page ?>"><i class="fa-solid fa-angles-left"></i></a>
                    </li>
                <?php
                }
                if ($current_page > 1) {
                ...
                ?>
                    <li class="page-item">
                        <a class="page-link mainMember prev-page-shopPage" value="<?php echo $current_page - 1 ?>"><i class="fa-solid fa-angle-left"></i></a>
                    </li>
                <?php } ?>
                ...
                <?php for ($num = 1; $num <= $totalPages; $num++) { ?>
                    <?php if ($num != $current_page) { ?>
                        <?php if ($num > $current_page - 3 && $num < $current_page + 3) { ?>
                            <li class="page-item <?php echo ($current_page == $num) ? 'active' : '' ?>"><a class="page-link mainMember" value="<?php echo $num ?>"><?php echo $num ?></a></li>
                        <?php } ?>
                    <?php } else { ?>
                        <li class="page-item <?php echo ($current_page == $num) ? 'active' : '' ?>"><a class="page-link mainMember" value="<?php echo $num ?>"><?php echo $num ?></a></li>
                    <?php } ?>
                ...
                ?>
                    <li class=" page-item">
                        <a class="page-link mainMember next-page-shopPage" value="<?php echo $current_page + 1 ?>"><i class="fa-solid fa-angle-right"></i></a>
                    </li>
                <?php
                }
                ...
                ?>
                    <li class="page-item">
                        <a class="page-link mainMember last-page-shopPage" value="<?php echo $end_page ?>"><i class="fa-solid fa-angles-right"></i></a>
                    </li>
                <?php
                }
                ?>
