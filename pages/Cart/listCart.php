    ...
    <div class="row  no-wrap cart align-items-center cart__wrapper">
        ...
        <div class="col">
            <div class="quantity_button-wrapper">
                <a class="minus-quantity-btn" value="<?php echo $row_cart['id_sanpham'] ?>"><input type="button"
                        value="-" class="minus-quantity button-quantity"></a>
                <input type="number" readonly class="input-text" step="1" min="1"
                    value="<?php echo $row_cart['amount'] ?>" id="quantity" placeholder inputmode="numeric">
                <a class="plus-quantity-btn" value="<?php echo $row_cart['id_sanpham'] ?>"><input type="button"
...
<?php } ?>
<?php } ?>
<div class="d-flex justify-content-between mb-3 cart__footer-back">
