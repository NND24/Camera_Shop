...
<div class="review-container">
    <div class="review__header">
        ...
        <?php
                if (($row['privilege'] == '1') || (isset($_SESSION['id_user']) && $_SESSION['id_user'] == $row_review['id_user'])) {
                ?>
    ...
    <?php
            if (strlen($row_review['answer_review']) && $row_review['id_admin'] != 0) {
                $sql_answer = "SELECT * FROM tbl_admin WHERE id_admin='$row_review[id_admin]' ";
    ...
    <div class="answer__wrapper">
        ...
        <div class="review__content">
            <div class="answer_review_content row">
                ...
                <?php
                            if ((isset($_SESSION['id_user']) && $_SESSION['id_user'] == $row_review['id_admin']) || $row['privilege'] == 1) {
                            ?>
