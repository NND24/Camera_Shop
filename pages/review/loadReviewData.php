...
?>
        <div class="review-container">
            ...
            <div class="review__content">
                ...
                if (isset($_SESSION['id_user']) && $_SESSION['id_user'] == $row_review['id_user']) {
                ?>
                    <button class="review__edit-modal-btn btn btn-primary" value="<?php echo $row_review['id_review'] ?>">Sửa</button>
                <?php
                }
                ?>
                ...
                <div class="answer__wrapper">
                    ...
                    <div class="review__content">
                        <div class="answer_review_content row">
                            ...
                            ?>
                                <button class="answer-review-delete-btn btn btn-danger col-1" value="<?php echo $row_review['id_review'] ?>">Xóa</button>
                            <?php
                            }
                            ?>
                        </div>
