...
?>
            <div class="row border-bottom">
                <div class="row main align-items-center cart__wrapper">
                    <div class="col-lg-1-5 col cart__img-product view__product-detail" value="<?php echo $cart_item['id'] ?>"><img class="img-fluid" src="./admin/modules/quanlysp/handleEvent/uploads/<?php echo $cart_item['hinhanh'] ?>">
                    </div>
                    ...
                    <div class="col">
                        <div class="quantity_button-wrapper">
                            <a class="minus-quantity-btn" value="<?php echo $cart_item['id'] ?>"><input type="button" value="-" class="minus-quantity button-quantity"></a>
                            <input type="number" name="quantity" class="input-text" step="1" min="1" value="<?php echo $cart_item['soluong'] ?>" id="quantity" placeholder inputmode="numeric">
                            <a class="plus-quantity-btn" value="<?php echo $cart_item['id'] ?>"><input type="button" value="+" class="plus-quantity button-quantity"></a>
                        </div>
                    </div>
