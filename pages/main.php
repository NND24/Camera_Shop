        ...
        <section class="section box__slide_home">
            <div class="section_content">
                <div class="row ">
                    <div class="col-3">
                        <ul class="home__menu">
                            <li><a href="#">Camera Yoosee</i></a></li>
                            <li><a href="#">Camera Ezviz</i></a></li>
                            <li><a href="#">Camera Imou</i></a></li>
                            <li><a href="#">Trọn bộ Camera Hikvision</i></a>
                            </li>
                            <li><a href="#">Camera Vantech</i></a>
                            </li>
                            <li><a href="#">Camera Kbvision</i></a></li>
                            <li><a href="#">Camera Dahua</i></a></li>
                            <li><a href="#">Camera Hikvision</i></a></li>
                            <li><a href="#">Phụ kiện Camera </i></a></li>
                        </ul>
                    </div>
                    <div class="col-9">
                        <div class="slide_ads">
