<div class="row no-wrap products-category">
    ...
    if ($_POST['priceRange'] == 1) {
        $sql_pro = "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.id_danhmuc='$_GET[id]' AND tbl_sanpham.giasp < 500000 ORDER BY id_sanpham ASC  LIMIT " . $item_per_page . " OFFSET " . $offset . " ";
        $query_pro = mysqli_query($mysqli, $sql_pro);

        $totalRecords = mysqli_query($mysqli, "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.id_danhmuc='$_GET[id]' AND tbl_sanpham.giasp < 500000 ORDER BY id_sanpham ASC");
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                <?php
                        ...
                        ?>
                <li class="page-item">
                    <a class="page-link order-range first-page-shopPage" value="<?php echo $first_page ?>"><i
                ...
                <?php
                        ...
                        ?>
                <li class="page-item">
                    <a class="page-link order-range prev-page-shopPage" value="<?php echo $current_page - 1 ?>"><i
                ...
                <?php
                        ...
                        ?>
                <li class=" page-item">
                    <a class="page-link order-range next-page-shopPage" value="<?php echo $current_page + 1 ?>"><i
                ...
                <?php
                        ...
                        ?>
                <li class="page-item">
                    <a class="page-link order-range last-page-shopPage" value="<?php echo $end_page ?>"><i
    ...
    <?php
        ...
        $sql_pro = "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.id_danhmuc='$_GET[id]' AND tbl_sanpham.giasp >= 500000 AND tbl_sanpham.giasp <= 2000000 ORDER BY id_sanpham ASC  LIMIT " . $item_per_page . " OFFSET " . $offset . "";
        $query_pro = mysqli_query($mysqli, $sql_pro);

        $totalRecords = mysqli_query($mysqli, "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.id_danhmuc='$_GET[id]' AND tbl_sanpham.giasp >= 500000 AND tbl_sanpham.giasp <= 2000000");
        $totalRecords = mysqli_num_rows($totalRecords);
        $totalPages = ceil($totalRecords / $item_per_page);
        if (mysqli_num_rows($query_pro) > 0) {
            while ($row_pro = mysqli_fetch_array($query_pro)) {
