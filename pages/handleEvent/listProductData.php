<?php if (isset($_GET['page']) && $_GET['page'] = 'main') { ?>
    <div class="row no-wrap products-category">
        ...
        $sql_pro = "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.id_danhmuc='$_GET[id]' ORDER BY daban ASC LIMIT " . $item_per_page . " OFFSET " . $offset . " ";
                        ...
                        <?php for ($num = 1; $num <= $totalPages; $num++) { ?>
                            <?php if ($num != $current_page) { ?>
                                <?php if ($num > $current_page - 3 && $num < $current_page + 3) { ?>
                                    <li class="page-item"><a class="page-link main" value="<?php echo $num ?>"><?php echo $num ?></a></li>
                                <?php } ?>
                            <?php } else { ?>
                                <li class="page-item"><a class="page-link main" value="<?php echo $num ?>"><?php echo $num ?></a></li>
                            <?php } ?>
