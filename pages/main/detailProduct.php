        ...
        <div class="product_main-container">
            <div class="row">
                <div class="col-lg-5 col product_category">
                    <img class="product_thumbnail" src="./admin/modules/quanlysp/uploads/<?php echo $row_chitiet['hinhanh'] ?>" alt="">
                </div>
                    ...
                    <form action="" class="cart">
                        <div class="quantity_wrapper">
                            ...
                            <div class="quantity_button-wrapper">
                                ...
                                <input type="number" name="quantity" class="input-text" step="1" min="1" value="1" id="quantity" placeholder inputmode="numeric">
                            ...
                            <div class=" row__item item--product">
                                <div class="row__item-container">
                                    <div class="row__item-display br-5">
                                        <div class="row__item-img" style="background: url('./images/products/yoosee-3-rau-3m.jpg') no-repeat center center / cover">
                                        </div>
                ...
                <div class="comment__form">
                    <form action="" method="post">
                        <div class="comment__input">
                            <textarea placeholder="Mời bạn tham gia thảo luận, vui lòng nhập tiếng Việt có dấu." name="" id="" cols="30" rows="10"></textarea>
                        </div>
