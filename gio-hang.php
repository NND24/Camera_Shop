...
<body class="container">
    ...
    <script>
        $(document).ready(() => {
            ...
            function view_cart() {
                $.post('pages/Cart/listgio-hang.php?pageIndex=' + pageIndexCart +
                    '&cartCount=' +
                    cartCount,
                    function(data) {
            ...
            $(document).on("click", '.page-link.cart', function() {
                ...
                $.ajax({
                    url: 'pages/Cart/listgio-hang.php?pageIndex=' +
            ...
            $(document).on("click", '.cart__delete-btn', function() {
                ...
                $.ajax({
                    url: "pages/Cart/handleDeletegio-hang.php?xoa=1",
                    data: {
            ...
            $(document).on("click", '.delete-all-cart-btn', function() {
                $.ajax({
                    url: "pages/Cart/handleDeletegio-hang.php?action=deleteAll",
                    dataType: 'json',
                    method: "post",
                    cache: true,
                    success: function() {
